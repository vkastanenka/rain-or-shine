...
import {
  transformOpenMeteoWeatherForecastResponseTimeInterval,
  type OpenMeteoWeatherForecastResponse,
} from "./entities";

function App() {
  const test = transformOpenMeteoWeatherForecastResponseTimeInterval(
    weatherResponse as OpenMeteoWeatherForecastResponse,
    "hourly",
  );
