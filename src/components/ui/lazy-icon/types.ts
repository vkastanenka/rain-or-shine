...
import type * as MeteoconIcons from "@/assets/icons/meteocons";
...
export type MeteoconIconName = keyof typeof MeteoconIcons;

export type LazyMeteoconIconProps = LazyIconProps<{
  name: MeteoconIconName;
}>;
